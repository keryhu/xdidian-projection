...
* @Description: TODO(当客户点击“重新发送激活邮件服务”的时候，需要执行的命令，其中验证url已经由其它service
* 完成)
* @author keryhu  keryhu@hotmail.com
* @date 2016年5月17日 下午5:24:27
*/
...
class ResendServiceImpl implements ResendService {
	...
	/**
	* <p>Title: exec</p>
	* <p>Description: 当客户点击“重新发送激活邮件服务”所执行的命令
	...
	*     </p>
	* @param email
	* @see com.xdidian.keryhu.emailActivate.service.ResendService#exec(java.lang.String)
	*/
	@Override
	...
	/**
	 * 
	* @Title: clickCoolingExpired
	* @Description: TODO(点击“重新发送”url的冷却时间，也就是客户不能连续点击 该url
	...
	* @throws
	...
	/**
	 * 
	* @Title: sendMoreThanLimit
	* @Description: TODO(查看当前email，点击“重新发送激活邮件的次数有没有超过限制
