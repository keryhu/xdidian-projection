...
/**
 * 
 * @Description : 用于email激活,发送相关的email激活码
 * ，点击“再次发送激活邮件”，“重新注册”应用的具体保存数据库的 实体类
 *   这个数据库实体，email和phone是分开的。
 * @date : 2016年6月18日 下午8:10:45
 * @author : keryHu keryhu@hotmail.com
 */
@Data
public class EmailActivatedToken implements Serializable {

  private static final long serialVersionUID = -3401500380279997241L;
